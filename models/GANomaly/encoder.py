...
class Encoder(nn.Module):
    def __init__(self, input_dimension, latent_dimension, features_count, layers=1):
        super().__init__()

        self.input = nn.Linear(features_count, features_count)
        ...
        self.final = nn.Linear(feats, latent_dimension)
